...
Public Class FileWrite
    ...
    Public Sub LoadUser()
        ...
        Using MyReader As New Microsoft.VisualBasic.FileIO.TextFieldParser("./CharData.csv")
            ...
            While Not DataGridView1.Rows.Count >= 80
    ...
    Public Sub SaveGame()
        WriteToTable(3, 3, Game.PlayerCurrentX)
        WriteToTable(4, 3, Game.PlayerCurrentY)
        WriteToTable(3, 2, Game.CurrentMap.mapname)
        WriteToTable(2, 5, Game.Storyprogress)
        WriteToTable(3, 5, Game.PlayerHealth)
        WriteToTable(4, 5, Game.PlayerMaxHealth)

        For i = 1 To 10
            For e = 1 To 20
                WriteToTable(i - 1, e + 29, Game.DrawnDisplay(i - 1, e - 1))
            Next
        Next
        WriteToTable(1, 7, "True")
        SaveToFile()
    End Sub
